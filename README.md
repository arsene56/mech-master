...
- 提供自行车固定挡位的原地踩踏演示：曲柄、脚踏、链条、后拨导轮、飞轮与后轮联动；可暂停、调速和结束，不改变拆装进度或存档。
...
10. 顶部“运转演示”可在整车组装完整时启动固定 36T / 24T 的原地踩踏，不额外生成脚撑或支架；顶部可暂停、继续和结束，左侧可在 30–90 转/分间调速。进入拆装、爆炸或收纳视图会结束演示并恢复静态姿态。演示链条单独显示为绕过两只后拨导轮的闭合链路，原有 110 个可拆链节及 595 个实体 ID 保持不变。
